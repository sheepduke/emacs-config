;;; selectrum-autoloads.el --- automatically extracted autoloads (do not edit)   -*- lexical-binding: t -*-
...
history item and exit use `selectrum-select-current-candidate'." t)
