...
(use-package emacs
  ...
  ("C-M-1" . persp-switch-to-1)
  ("C-M-2" . persp-switch-to-2)
  ("C-M-3" . persp-switch-to-3)
  ("C-M-4" . persp-switch-to-4)
  ("C-M-5" . persp-switch-to-5)
  ("C-M-6" . persp-switch-to-6)
  ("C-M-7" . persp-switch-to-7)
  ("C-M-8" . persp-switch-to-8)
  ("C-M-9" . persp-switch-to-9)
